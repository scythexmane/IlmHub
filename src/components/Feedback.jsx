...
const testimonialsData = [
  ...
  { id: 3, nameKey: 'testimonial3.name', quoteKey: 'testimonial3.quote', rating: 5, avatar: 'avatar-3.jpg' },
  { id: 4, nameKey: 'testimonial4.name', quoteKey: 'testimonial4.quote', rating: 5, avatar: 'avatar-4.jpg' },
  { id: 5, nameKey: 'testimonial5.name', quoteKey: 'testimonial5.quote', rating: 4, avatar: 'avatar-5.jpg' },
  { id: 6, nameKey: 'testimonial6.name', quoteKey: 'testimonial6.quote', rating: 5, avatar: 'avatar-6.jpg' },
  { id: 7, nameKey: 'testimonial7.name', quoteKey: 'testimonial7.quote', rating: 3.5, avatar: 'avatar-7.jpg' },
  { id: 8, nameKey: 'testimonial8.name', quoteKey: 'testimonial8.quote', rating: 4.5, avatar: 'avatar-8.jpg' },
];
      ...
      {hasHalfStar && (
        ...
        >
          <defs>
            ...
            <linearGradient id={`half-star-gradient-${Math.random().toString(36).substring(7)}`}>
              <stop offset="50%" stopColor="currentColor" />
              <stop offset="50%" stopColor="transparent" />
            </linearGradient>
          </defs>
          <path
            fill={`url(#half-star-gradient-${Math.random().toString(36).substring(7)})`}
      ...
      <div className="relative z-10 flex flex-col h-full">
        <div className="flex items-center mb-5 flex-shrink-0">
          <img
            ...
            onError={(e) => { e.target.onerror = null; e.target.src = 'https://placehold.co/150x150/9CA3AF/374151?text=User'; }}
          />
          <div>
            <h3 className="font-extrabold text-xl text-[--color-text] tracking-tight mb-0.5">{t(nameKey)}</h3>
        ...
        <blockquote className="text-[--color-text-light] text-lg leading-relaxed mt-4 italic relative flex-grow overflow-hidden text-ellipsis testimonial-quote">
          <span className="absolute -top-4 -left-4 text-6xl font-serif text-[--color-primary]/20 opacity-70">"</span>
          "{t(quoteKey)}"
          <span className="absolute -bottom-4 -right-4 text-6xl font-serif text-[--color-primary]/20 opacity-70 rotate-180">"</span>
        </blockquote>
      </div>
    </motion.div>
  );
...
const resources = {
  en: {
    translation: {
      ...
      "testimonial1.quote": "The best service I've ever experienced! Highly recommend.",
      "testimonial2.name": "Maria Rodriguez",
      "testimonial2.quote": "Absolutely transformed our workflow. Incredible product!",
      "testimonial3.name": "David Lee",
      "testimonial3.quote": "Exceptional quality and outstanding support. A true game-changer!",
      "testimonial4.name": "Sophia Chen",
      "testimonial4.quote": "User-friendly interface and powerful features. Couldn't be happier.",
      "testimonial5.name": "Omar Al-Farsi",
      "testimonial5.quote": "Reliable and efficient. It has streamlined our operations significantly.",
      "testimonial6.name": "Emily White",
      "testimonial6.quote": "Fantastic team and a product that truly delivers on its promises.",
      "testimonial7.name": "Liam Murphy",
      "testimonial7.quote": "Good start, but there's room for improvement in integration options.",
      "testimonial8.name": "Chloe Green",
      "testimonial8.quote": "A solid solution that met all our needs. Very impressed with the results.",
    }
  },
  ru: {
    translation: {
      ...
      "testimonial1.quote": "Лучший сервис, который я когда-либо встречал! Настоятельно рекомендую.",
      "testimonial2.name": "Мария Родригес",
      "testimonial2.quote": "Полностью изменил наш рабочий процесс. Невероятный продукт!",
      "testimonial3.name": "Дэвид Ли",
      "testimonial3.quote": "Исключительное качество и выдающаяся поддержка. Настоящий прорыв!",
      "testimonial4.name": "София Чен",
      "testimonial4.quote": "Удобный интерфейс и мощные функции. Очень доволен.",
      "testimonial5.name": "Омар Аль-Фарси",
      "testimonial5.quote": "Надежный и эффективный. Значительно упростил наши операции.",
      "testimonial6.name": "Эмили Уайт",
      "testimonial6.quote": "Фантастическая команда и продукт, который действительно выполняет свои обещания.",
      "testimonial7.name": "Лиам Мерфи",
      "testimonial7.quote": "Хорошее начало, но есть куда расти в плане интеграций.",
      "testimonial8.name": "Хлоя Грин",
      "testimonial8.quote": "Надежное решение, которое удовлетворило все наши потребности. Очень впечатлены результатами.",
    }
  },
  uz: {
    translation: {
      ...
      "testimonial1.quote": "Men ko'rgan eng yaxshi xizmat! Juda tavsiya qilaman.",
      "testimonial2.name": "Mariya Rodriges",
      "testimonial2.quote": "Bizning ish jarayonimizni butunlay o'zgartirdi. Ajoyib mahsulot!",
      "testimonial3.name": "Devid Li",
      "testimonial3.quote": "Ajoyib sifat va a'lo darajadagi qo'llab-quvvatlash. Haqiqiy o'yin o'zgartiruvchi!",
      "testimonial4.name": "Sofiya Chen",
      "testimonial4.quote": "Foydalanuvchi uchun qulay interfeys va kuchli xususiyatlar. Juda mamnunman.",
      "testimonial5.name": "Umar Al-Farsi",
      "testimonial5.quote": "Ishonchli va samarali. U bizning operatsiyalarimizni sezilarli darajada soddalashtirdi.",
      "testimonial6.name": "Emili Uayt",
      "testimonial6.quote": "Ajoyib jamoa va o'z va'dalarini chindan ham bajaradigan mahsulot.",
      "testimonial7.name": "Liyam Merfi",
      "testimonial7.quote": "Yaxshi boshlanish, ammo integratsiya variantlarida yaxshilash uchun joy bor.",
      "testimonial8.name": "Chloe Green",
      "testimonial8.quote": "Barcha ehtiyojlarimizni qondiradigan mustahkam yechim. Natijalar juda taassurot qoldirdi.",
    }
  }
};
