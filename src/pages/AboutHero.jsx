...
import { useTheme } from "../ThemeContext"; // адаптируй путь
  ...
  return (
    <div
      ...
      className={`h-[400vh] w-full ${
        isDark ? "bg-gray-950 border border-white/10" : "bg-white"
      } rounded-md relative pt-40 overflow-clip transition-colors duration-500`}
    >
      <div className="sticky top-80">
        <p className="text-lg md:text-7xl font-extrabold pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-400 to-neutral-300 leading-tight">
          {t("aboutHero.title")}
          <br />
          <span className="bg-gradient-to-r from-sky-400 via-fuchsia-500 to-rose-500 bg-clip-text text-transparent">
            {t("aboutHero.brand")}
          </span>
        </p>

        <div className="w-full h-[890px] -top-60 md:-top-40 flex items-center justify-center absolute">
          <button className="font-bold bg-gradient-to-r from-sky-600 via-fuchsia-500 to-rose-300 text-black rounded-full md:px-4 md:py-2 px-2 py-1 md:mt-24 mt-8 z-30 md:text-base text-xs w-fit mx-auto">
            www.ilmhub.uz
          </button>
        </div>
        <svg
